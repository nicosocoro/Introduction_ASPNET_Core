    ...
    public class dBLog
    {
        ...
        List<eBlog> lst_blogs
        {
            get
            {
                ...
                {
                    new eBlog(1, "How to make your first ASP NET Core Application", "https://medium.com/@nicolassocoro/asp-net-core-working-with-docker-de90a6bf67e4", new List<string>{ "microsoft", "asp", "net" }, auth1),
